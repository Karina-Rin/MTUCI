...
class Blockchain(object):
    ...
    def register_node(self, address):
        ...
        :param address: <str> адрес узла , другими словами:
    ...
    def hash(block):
        ...
        # Мы должны убедиться в том, что словарь упорядочен, иначе у нас будут
        # непоследовательные хеши
    ...
    def valid_proof(last_proof, proof):
        """
        Подтверждение доказательства: Содержит ли hash(last_proof, proof)
        4 заглавных нуля?
...
def mine():
    # Мы запускаем алгоритм подтверждения работы, чтобы получить следующее
    # подтверждение…
...
def new_transaction():
    ...
    index = blockchain.new_transaction(values[
        'sender'], values['recipient'], values['amount'])
